...
// =========== React component ===========
export default function ASCIIText({ text = "Hi!", asciiFontSize = 8, textFontSize = 200, textColor = "#fdf9f3", planeBaseHeight = 8, enableWaves = true }) {
  ...
  return (
    <div ref={containerRef} className="w-full h-full top-0 left-0">
      <style>{`
